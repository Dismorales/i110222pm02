...
!(function (t) {
                ...
                h(e, function (s, a) {
                    u.fn[s] ||
                        (u.fn[s] = function (t) {
                            ...
                            return "undefined" === n
                                ? i
                                : ("function" === n && (n = g((t = t.call(this, i)))), null == t && a.empty ? this : ("string" === n && (e = f.exec(t)) && (t = i + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)), (o[a.idx] = t), this[r](o)));
                        });
                });
        }),
        (u.hook = function (t) {
    ...
    function T(t, e, n, r) {
        return (
            ...
            "function" == typeof (e = null == e ? {} : e) && ((r = e), (n = null), (e = {})),
    ...
    function R(t, e) {
        ...
        return { top: parseFloat(t[1]) || 0, right: "auto" === t[2] ? n : parseFloat(t[2]), bottom: "auto" === t[3] ? e : parseFloat(t[3]), left: parseFloat(t[4]) || 0 };
    }
    (d.effects = { effect: {} }),
        (v = ["add", "remove", "toggle"]),
        (x = { border: 1, borderBottom: 1, borderColor: 1, borderLeft: 1, borderRight: 1, borderTop: 1, borderWidth: 1, margin: 1, padding: 1 }),
        ...
        d.fn.extend({
            addClass:
                ((y = d.fn.addClass),
                function (t, e, n, r) {
                    return e ? d.effects.animateClass.call(this, { add: t }, e, n, r) : y.apply(this, arguments);
                }),
            removeClass:
                ((b = d.fn.removeClass),
                function (t, e, n, r) {
                    return 1 < arguments.length ? d.effects.animateClass.call(this, { remove: t }, e, n, r) : b.apply(this, arguments);
                }),
            toggleClass:
                ((i = d.fn.toggleClass),
                function (t, e, n, r, o) {
                    return "boolean" == typeof e || void 0 === e ? (n ? d.effects.animateClass.call(this, e ? { add: t } : { remove: t }, n, r, o) : i.apply(this, arguments)) : d.effects.animateClass.call(this, { toggle: t }, e, n, r);
                }),
            switchClass: function (t, e, n, r, o) {
                return d.effects.animateClass.call(this, { add: e, remove: t }, n, r, o);
            },
        }),
        d.expr &&
            d.expr.pseudos &&
            ...
            d.extend(d.effects, {
                ...
                createWrapper: function (n) {
                    ...
                    var r = { width: n.outerWidth(!0), height: n.outerHeight(!0), float: n.css("float") },
                        t = d("<div></div>").addClass("ui-effects-wrapper").css({ fontSize: "100%", background: "transparent", border: "none", margin: 0, padding: 0 }),
        ...
        d.extend(d.effects, {
            ...
            scaledDimensions: function (t, e, n) {
                ...
                return { height: t.height() * e, width: t.width() * r, outerHeight: t.outerHeight() * e, outerWidth: t.outerWidth() * r };
            },
        ...
        d.fn.extend({
            ...
            transfer: function (t, e) {
                var n = d(this),
                    ...
                    a = o ? i.scrollLeft() : 0,
                    i = r.offset(),
                    i = { top: i.top - s, left: i.left - a, height: r.innerHeight(), width: r.innerWidth() },
                    r = n.offset(),
                    c = d("<div class='ui-effects-transfer'></div>");
                c.appendTo("body")
                    .addClass(t.className)
                    .css({ top: r.top - s, left: r.left - a, height: n.innerHeight(), width: n.innerWidth(), position: o ? "fixed" : "absolute" })
        ...
        (d.fx.step.clip = function (t) {
            t.clipInit || ((t.start = d(t.elem).cssClip()), "string" == typeof t.end && (t.end = R(t.end, t.elem)), (t.clipInit = !0)),
                d(t.elem).cssClip({
    ...
    d.effects,
        d.effects.define("slide", "show", function (t, e) {
            var n,
                r,
                o = d(this),
                i = { up: ["bottom", "top"], down: ["top", "bottom"], left: ["right", "left"], right: ["left", "right"] },
                s = t.mode,
                a = t.direction || "left",
            ...
            d.effects.createPlaceholder(o),
                ...
                "show" === s && (o.cssClip(l.clip), o.css(c, l[c]), (l.clip = n), (l[c] = r)),
                o.animate(l, { queue: !1, duration: t.duration, easing: t.easing, complete: e });
        });
});
